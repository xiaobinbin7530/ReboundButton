package com.linekong.rebound.reboundbutton;
...
public class MySpringSwitchButton extends View implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private final int DEFAULT_TEXTPADDING = 14;
    ...
    private String leftText = "启用";
    private String rightText = "禁用";
...
//        canvas.drawRoundRect(backRect, getMeasuredHeight() / 2, getMeasuredHeight() / 2, backPaint);
        canvas.drawRoundRect(backRect, 0, 0, backPaint);
        canvas.restore();
